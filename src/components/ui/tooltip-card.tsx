      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-xl border border-white/20 bg-black/90 backdrop-blur-xl shadow-2xl shadow-black/50"
            style={{
              top: position.y,
              left: position.x,
            }}
          >
            <div
              ref={contentRef}
              className="p-3 text-sm text-text-gray"
            >
              {content}
            </div>
          </motion.div>
